...
public class Gluecode {
	...
	public void the_user_is_redirected_to_the_employee_page() {
		...
		loginButton.click();
		Assert.assertEquals("http://localhost:8080/home.html", driver.getCurrentUrl());
		try {
			Thread.sleep(5000);
	...
	public void the_user_is_redirected_to_the_manager_page() {
		WebElement loginButton = driver.findElement(By.id("submit"));
		loginButton.click();
		Assert.assertEquals("http://localhost:8080/managerhome.html", driver.getCurrentUrl());
		try {
			Thread.sleep(5000);
		} catch (InterruptedException e) {
			e.printStackTrace();
	...
	public void the_user_is_redirected_to_the_login_page() {
		Assert.assertEquals("http://localhost:8080/loginpage.html", driver.getCurrentUrl());
		try {
			Thread.sleep(5000);
		} catch (InterruptedException e) {
			e.printStackTrace();
	...
	public void the_user_is_redirected_to_the_statistics_page() {
		Assert.assertEquals("http://localhost:8080/statistics.html", driver.getCurrentUrl());
		try {
			Thread.sleep(5000);
		} catch (InterruptedException e) {
			e.printStackTrace();
